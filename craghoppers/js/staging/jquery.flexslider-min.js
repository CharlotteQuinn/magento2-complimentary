...
requirejs(['jquery'], function($) {
	!function($) {
		...
		$.flexslider=function(t, a) {
			...
			s=("ontouchstart"in window||r||window.DocumentTouch&&document instanceof DocumentTouch)&&n.vars.touch,o="click touchend MSPointerUp keyup",l="",c,d="vertical"===n.vars.direction,u=n.vars.reverse,v=n.vars.itemWidth>0,p="fade"===n.vars.animation,m=""!==n.vars.asNavFor,f= {
			}
			...
			$.data(t, "flexslider", n),f= {
				init:function() {
					...
					"slide"===n.vars.animation&&(n.vars.animation="swing"),n.prop=d?"top":n.vars.rtl?"marginRight":"marginLeft",n.args= {
					}
				...
				controlNav: {
					...
					setupPaging:function() {
						...
						if(n.controlNavScaffold=$('<ol class="'+i+"control-nav "+i+e+'"></ol>'), n.pagingCount>1)for(var s=0;
						s<n.pagingCount;
				...
				touch:function() {
					...
					function a(e) {
						...
						if(a) {
							...
							if(w+=d?i:n, m=(a.vars.rtl?-1:1)*w,
							x=d?Math.abs(w)<Math.abs(-n):Math.abs(w)<Math.abs(-i),e.detail===e.MSGESTURE_FLAG_INERTIA)return void setImmediate(function() {
								t._gesture.stop()
							}
					...
					r?(t.style.msTouchAction="none", t._gesture=new MSGesture, t._gesture.target=t, t.addEventListener("MSPointerDown",e,!1),
					t._slider=n,
			...
			n.flexAnimate=function(e, t, a, r, o) {
				...
				!n.animating&&(n.canAdvance(e,o)||a)&&n.is(":visible")) {
					...
					if(n.animating=!0, n.animatingTo=e, t&&n.pause(),
					n.vars.before(n),
					...
					n.vars.animationLoop||n.pause()),p)s?(n.slides.eq(n.currentSlide).css( {
						opacity: 0, zIndex:1
					}
					...
					, n.vars.animationSpeed, n.vars.easing, n.wrapup));
						...
						n.transitions?(n.vars.animationLoop&&n.atEnd||(n.animating=!1,n.currentSlide=n.animatingTo),
			...
			n.setup=function(e) {
				...
				, n.vars.animationSpeed, n.vars.easing)), n.vars.smoothHeight&&f.smoothHeight();
					...
					n.slides=$(a),
					n.container.empty().append(n.slides))),
					n.vars.animationLoop&&!v&&(n.cloneCount=2, n.cloneOffset=1, "init"!==e&&n.container.find(".clone").remove(),
